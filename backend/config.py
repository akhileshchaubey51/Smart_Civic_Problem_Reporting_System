...
class Config:
    ...
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_DEFAULT_SENDER', 'CampusCare Grievance Cell <notifications@kiet.edu>')
    ADMIN_NOTIFICATION_EMAIL = os.getenv('ADMIN_NOTIFICATION_EMAIL', 'admin@kiet.edu')
